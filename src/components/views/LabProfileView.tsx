          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <TicketCard entity={lab} config={TicketConfig.lab} />
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-lg text-teal-700 font-semibold mb-2">{lab.specialty}</p>
                <p className="text-sm text-slate-500 mb-4">
                  <span className="font-semibold text-slate-700">Qualification:</span> {lab.qualification} <span className="mx-2">•</span> <span className="font-semibold text-slate-700">Experience:</span> {lab.experience}
                </p>
                <div className="flex items-center justify-center md:justify-start gap-2">
                  <span className="flex items-center text-amber-400">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                    <span className="ml-1 text-sm font-bold text-slate-700">{lab.rating}</span>
                  </span>
                  <span className="text-sm text-slate-400">({lab.reviews} Reviews)</span>
                </div>
              </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="space-y-4 mt-4">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <p className="text-sm text-slate-900 font-semibold">{lab.clinic.phone}</p>
                      </div>
                    </div>
                  </div>
                </div>
