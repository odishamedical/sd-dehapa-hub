  ...
  return (
    <div className="min-h-screen bg-[#050B14] flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 flex items-center justify-center pointer-events-none opacity-50">
        <div className="w-[80vw] h-[80vw] md:w-[40vw] md:h-[40vw] rounded-full border border-teal-500/10 absolute animate-ping" style={{ animationDuration: '3s' }}></div>
        <div className="w-[60vw] h-[60vw] md:w-[30vw] md:h-[30vw] rounded-full border border-teal-500/20 absolute animate-ping" style={{ animationDuration: '3s', animationDelay: '1s' }}></div>
        <div className="w-[40vw] h-[40vw] md:w-[20vw] md:h-[20vw] rounded-full border border-teal-500/30 absolute animate-ping" style={{ animationDuration: '3s', animationDelay: '2s' }}></div>
        <div className="absolute top-1/2 left-1/2 w-[100vw] h-[2px] bg-gradient-to-r from-transparent via-teal-500/20 to-transparent -translate-x-1/2 -translate-y-1/2 animate-spin-slow"></div>
      </div>

      <div className="relative z-10 flex flex-col items-center text-center">
        <div className="w-24 h-24 rounded-full bg-teal-600 border-4 border-teal-900 flex items-center justify-center shadow-[0_0_50px_rgba(20,184,166,0.6)] mb-8 relative">
        ...
        <p className="text-teal-200 text-lg mb-8 max-w-md">
        ...
        <div className="bg-black/40 border border-white/10 rounded-2xl p-6 w-full max-w-md backdrop-blur-md">
          ...
          <div className="flex justify-between items-center mb-3">
            ...
            <span className="text-teal-400 font-bold">{queueData?.requiredTier}</span>
          </div>
