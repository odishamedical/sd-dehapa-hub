          ...
          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-6 mb-10 relative overflow-hidden group">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div>
                ...
                <div className="bg-white border border-amber-200 px-4 py-2 rounded-lg text-amber-900 font-mono text-xs sm:text-sm break-all shadow-inner">
                  {currentUglyUrl}
                </div>
              </div>
              <div className="shrink-0 text-center md:text-right">
                <p className="text-sm font-bold text-slate-700 mb-1">Make it clean.</p>
                <p className="text-lg font-serif font-bold text-teal-700">dehapa.com/dr-{currentName.split(' ')[0].toLowerCase() || 'name'}</p>
              </div>
            </div>
          </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="border-2 border-slate-200 hover:border-slate-300 rounded-2xl p-6 bg-white transition-colors relative flex flex-col">
                      ...
                      <p className="font-mono text-sm text-slate-900 mb-6 bg-slate-50 p-3 rounded-lg border border-slate-100 break-all">
                    ...
                    <div className="border-2 border-teal-500 rounded-2xl p-6 bg-teal-50/30 relative flex flex-col shadow-xl shadow-teal-900/5 transform md:-translate-y-4">
                      ...
                      <p className="font-mono text-sm text-slate-900 mb-6 bg-white p-3 rounded-lg border border-teal-100 shadow-sm break-all">
                    ...
                    <div className="border-2 border-amber-400 rounded-2xl p-6 bg-gradient-to-b from-amber-50 to-white relative flex flex-col shadow-lg">
                      ...
                      <p className="font-mono text-sm text-slate-900 mb-6 bg-white p-3 rounded-lg border border-amber-200 shadow-sm break-all">
