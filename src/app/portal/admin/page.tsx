                        ...
                        <tr key={claim.id} className="hover:bg-slate-50/80 transition-colors group">
                          ...
                          <td className="px-6 py-4">
                            <div className="flex flex-col gap-1">
                              ...
                              {claim.proofUrl && (
                                <a href={claim.proofUrl} target="_blank" rel="noreferrer" className="text-xs font-bold text-blue-600 hover:text-blue-800 underline mt-1">
                                  View Uploaded Proof
                                </a>
                              )}
                            </div>
                          ...
                          <td className="px-6 py-4 text-right">
                            {claim.status === 'pending' ? (
                              <div className="flex flex-col items-end gap-2">
                                ...
                                {claim.listingId && claim.listingId !== "new_listing" && (
                                  <a href={`/${claim.entityType.toLowerCase()}s/${claim.listingId}`} target="_blank" rel="noreferrer" className="text-[10px] font-bold text-slate-500 hover:text-teal-600 hover:underline uppercase tracking-widest flex items-center gap-1">
