            ...
            <div className="bg-gradient-to-b from-slate-800 to-slate-900 rounded-[32px] p-6 md:p-8 shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-slate-700/60 relative overflow-hidden">
               ...
               <div className="mt-6 pt-6 border-t border-slate-700/50 relative z-10 flex flex-col gap-3">
                 ...
                 <div className="flex gap-3">
                   <button 
                     onClick={() => window.open(`https://api.whatsapp.com/send?text=${encodeURIComponent('Book an appointment with ' + doctor.name + ' on DehaPa Hub: https://sd-dehapa-hub.vercel.app/doctors/' + (customSlug || id))}`, '_blank')}
                   ...
                   <button 
                     onClick={() => window.open(`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent('https://sd-dehapa-hub.vercel.app/doctors/' + (customSlug || id))}`, '_blank')}
