            ...
            {filteredAppointments.map(apt => (
              <div key={apt.id} className="bg-white/60 backdrop-blur-xl border border-white rounded-2xl p-6 shadow-sm hover:shadow-md transition-all group relative overflow-hidden">
                ...
                {apt.status === 'confirmed' && (
                  <div className="flex items-center gap-2">
                    {apt.type === 'telemedicine' ? (
                      <button className="flex-1 bg-blue-500 hover:bg-blue-600 text-white py-2.5 rounded-xl text-sm font-bold shadow-sm transition-colors flex justify-center items-center gap-2">
