...
export default function LabProfileView({ id, customSlug }: { id?: string, customSlug?: string }) {
      ...
      try {
        ...
        if (docSnap && docSnap.exists && docSnap.exists() || (docSnap && docSnap.data)) {
          ...
          try {
            ...
            console.error("Failed to fetch similar labs", e);
          }
  ...
  return <UnifiedProfileLayout profile={lab} type="lab" similarEntities={similarEntities} platformAds={platformAds} canEdit={canEdit} onInlineSave={handleInlineSave} />;
}
