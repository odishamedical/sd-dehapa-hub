...
export default function V2LabProfile({ params }: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        ...
        else setProfile({ id: unwrappedParams.id, name: "City Diagnostics (Mock)", labType: "Pathology", homeCollection: true, timings: "8AM - 8PM", rating: "4.7" });
      } catch (e) {
  ...
  return <><V2Header /><V2UnifiedProfileLayout profile={profile} type="lab" /></>;
}
