        ...
        <div className="max-w-5xl mx-auto space-y-8 pb-32">
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-slate-200 p-8">
              <div className="flex justify-between items-start mb-6">
                ...
                <button className="px-4 py-2 bg-indigo-50 text-indigo-700 font-bold text-sm rounded-xl border border-indigo-100 hover:bg-indigo-100 flex items-center gap-2 transition-colors">
