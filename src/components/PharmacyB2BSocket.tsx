...
export default function PharmacyB2BSocket() {
  const [hospitalId, setHospitalId] = useState("");
  const [isLinking, setIsLinking] = useState(false);
  const [activeSockets, setActiveSockets] = useState([
    { id: "hosp_8231", name: "Care Hospitals, Bhubaneswar", status: "Connected", syncType: "Live Inventory + Rx Dispatch" }
  ]);
    ...
    <div className="bg-white/40 backdrop-blur-2xl border border-white/60 rounded-[32px] p-6 md:p-8 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1),inset_0_1px_3px_rgba(255,255,255,0.8)] min-h-[70vh]">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
          ...
          <p className="text-sm text-slate-600 mt-2 font-medium">Link directly to a Hospital OS to automate IPD supply and internal prescriptions.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-purple-50 border border-purple-100 p-4 rounded-xl flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-purple-700 mt-1">When connected, any prescription generated by the Hospital's doctors will bypass the patient app and ping directly into your fulfillment dashboard.</p>
              </div>
            </div>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 shadow-xl relative overflow-hidden">
          ...
          <h4 className="font-bold text-white text-sm uppercase tracking-widest mb-6 relative z-10">Active Data Sockets</h4>
