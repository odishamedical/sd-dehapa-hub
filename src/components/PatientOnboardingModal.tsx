        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          <div>
            ...
            <input 
              ...
              className="w-full bg-white/50 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:border-teal-500 focus:ring-1 focus:ring-teal-500 outline-none transition-colors" 
          ...
          {!sameAsPhone && (
            <div className="animate-in slide-in-from-top-2 duration-300">
              <label className="block text-xs font-bold uppercase tracking-widest text-slate-500 mb-1 flex items-center gap-2">
                WhatsApp Number
