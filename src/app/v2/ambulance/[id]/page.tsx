...
export default function V2AmbulanceProfile({ params }: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        ...
        else setProfile({ id: unwrappedParams.id, name: "LifeLine Ambulance (Mock)", lifeSupportLevel: "ALS", fleetSize: "12", coverageRadius: "100km", baseLocation: "Cuttack, Odisha" });
      } catch (e) {
  ...
  return <><V2Header /><V2UnifiedProfileLayout profile={profile} type="ambulance" /></>;
}
