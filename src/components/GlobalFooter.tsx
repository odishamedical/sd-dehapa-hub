        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_1.5fr_1.5fr_1.5fr] gap-8 lg:gap-10 mb-8">
          ...
          <div className="order-last lg:order-first mt-8 lg:mt-0 pt-8 lg:pt-0 border-t border-slate-800 lg:border-none pr-0 lg:pr-8">
            ...
            <div className="flex flex-wrap gap-4">
              <button className="h-12 flex items-center bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 border border-blue-400 shadow-[0_0_20px_rgba(37,99,235,0.3)] rounded-xl px-4 py-2 transition-all hover:-translate-y-1 hover:shadow-[0_0_30px_rgba(37,99,235,0.5)] group">
                <svg className="w-6 h-6 mr-2 text-white group-hover:scale-110 transition-transform" viewBox="0 0 384 512" fill="currentColor"><path d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.7-44.6-35.5-2.8-74.3 20.7-88.5 20.7-15 0-49.4-19.7-76.4-19.7C63.3 141.2 4 184.8 4 273.5q0 39.3 14.4 81.2c12.8 36.7 59 126.7 107.2 125.2 25.2-.6 43-17.9 75.8-17.9 31.8 0 48.3 17.9 76.4 17.9 48.6-.7 90.4-82.5 102.6-119.3-65.2-30.7-61.7-90-61.7-91.9zm-56.6-164.2c27.3-32.4 24.8-61.9 24-72.5-24.1 1.4-52 16.4-67.9 34.9-17.5 19.8-27.8 44.3-25.6 71.9 26.1 2 49.9-11.4 69.5-34.3z"></path></svg>
                <div className="flex flex-col items-start justify-center">
                  <span className="text-[9px] font-medium leading-none text-blue-100">Download on the</span>
                  <span className="text-sm font-bold leading-none text-white mt-1">App Store</span>
                </div>
              </button>
              <button className="h-12 flex items-center bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-500 hover:to-emerald-600 border border-emerald-400 shadow-[0_0_20px_rgba(16,185,129,0.3)] rounded-xl px-4 py-2 transition-all hover:-translate-y-1 hover:shadow-[0_0_30px_rgba(16,185,129,0.5)] group">
                <svg className="w-6 h-6 mr-2 text-white group-hover:scale-110 transition-transform" viewBox="0 0 512 512" fill="currentColor"><path d="M325.3 234.3L104.6 13l280.8 161.2-60.1 60.1zM47 0C34 6.8 25.3 19.2 25.3 35.3v441.3c0 16.1 8.7 28.5 21.7 35.3l256.6-256L47 0zm425.2 225.6l-58.9-34.1-65.7 64.5 65.7 64.5 60.1-34.1c18-14.3 18-46.5-1.2-60.8zM104.6 499l280.8-161.2-60.1-60.1L104.6 499z"></path></svg>
                <div className="flex flex-col items-start justify-center">
                  <span className="text-[9px] font-medium leading-none text-emerald-100">GET IT ON</span>
