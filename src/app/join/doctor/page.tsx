      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 pt-12 md:pt-24">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-32">
          <div className="animate-in fade-in slide-in-from-bottom-8 duration-1000">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="https://sd-auth-center.vercel.app/register?role=doctor" className="inline-flex justify-center items-center gap-2 bg-gradient-to-r from-teal-500 to-emerald-600 hover:from-teal-400 hover:to-emerald-500 text-white font-black px-8 py-4 rounded-xl shadow-[0_0_30px_rgba(20,184,166,0.3)] transition-all hover:scale-105 hover:shadow-[0_0_40px_rgba(20,184,166,0.5)]">
                Register as Doctor
                <ArrowRight className="w-5 h-5" />
              </Link>
              <Link href="/portal/doctor" className="inline-flex justify-center items-center gap-2 bg-slate-800 hover:bg-slate-700 text-white font-bold px-8 py-4 rounded-xl border border-slate-700 transition-all">
                Provider Login
              </Link>
            </div>
        ...
        <div className="bg-slate-800/30 border border-slate-800 rounded-3xl p-8 md:p-12 mb-20 flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="w-full md:w-auto">
            <Link href="https://sd-auth-center.vercel.app/register?role=doctor" className="w-full sm:w-auto inline-flex justify-center items-center gap-2 bg-white text-slate-900 hover:bg-slate-200 font-black px-8 py-4 rounded-xl transition-all">
              Start Verification
              <ArrowRight className="w-5 h-5" />
            </Link>
          </div>
