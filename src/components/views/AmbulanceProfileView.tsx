  ...
  if (!ambulance) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#040815]">
        <h2 className="text-2xl font-bold text-white mb-2">Ambulance Not Found</h2>
        <Link href="/ambulances" className="text-cyan-400 hover:underline font-bold uppercase tracking-widest text-sm">Return to Directory</Link>
      </div>
    );
  }
