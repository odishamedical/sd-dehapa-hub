  ...
  return (
    <div className="bg-white/50 backdrop-blur-md rounded-[24px] p-8 border border-white/60 shadow-[inset_0_2px_4px_rgba(255,255,255,0.5),0_10px_30px_rgba(0,0,0,0.05)] w-full">
      ...
      >
        ...
        <p className="text-sm text-slate-500 mb-2">Supports JPG, PNG, WEBP (Max 5MB per image)</p>
        <p className="text-xs font-bold text-amber-500 bg-amber-50 inline-block px-3 py-1 rounded-full border border-amber-200 mb-6">For best display, use Widescreen (16:9) aspect ratio</p>
