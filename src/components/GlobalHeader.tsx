            ...
            {dropdownOpen && (
              <div className="absolute right-0 mt-4 w-72 bg-[#0a111a]/95 backdrop-blur-xl border border-slate-700 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.7)] py-3 z-[110] text-left overflow-hidden">
                ...
                {(userRole === "doctor" || userRole === "hospital" || userRole === "pharmacy" || userRole === "lab" || userRole === "ambulance") && (
                  <div className="py-2">
                    <a href={`/portal/${userRole}`} className="flex items-center gap-3 px-5 py-3 text-sm text-teal-400 hover:text-cyan-300 hover:bg-cyan-500/10 transition-colors group">
                    ...
                    {userRole === "doctor" && (
                      <a href="/portal/patients" className="flex items-center gap-3 px-5 py-3 text-sm text-slate-300 hover:text-cyan-300 hover:bg-cyan-500/10 transition-colors group">
                        <svg className="w-4 h-4 text-slate-500 group-hover:text-cyan-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                        <span className="font-bold">Patient Records</span>
                      </a>
                    )}
                    <a href="/portal/earnings" className="flex items-center gap-3 px-5 py-3 text-sm text-slate-300 hover:text-cyan-300 hover:bg-cyan-500/10 transition-colors group">
                ...
                {(userRole === "super_admin" || userRole === "admin") && (
                  <div className="py-2">
                    ...
                    <a href="/portal/analytics" className="flex items-center gap-3 px-5 py-3 text-sm text-slate-300 hover:text-cyan-300 hover:bg-cyan-500/10 transition-colors group">
                      <svg className="w-4 h-4 text-slate-500 group-hover:text-cyan-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                      <span className="font-bold">Global Analytics</span>
                    </a>
                    <a href="/login/launcher" className="flex items-center gap-3 px-5 py-3 text-sm text-cyan-400 hover:text-cyan-300 hover:bg-cyan-500/10 transition-colors group">
