...
export default function DigitalRxPad({ patient, onClose, onSave }: DigitalRxPadProps) {
  ...
  const content = (
    <div className="fixed inset-0 z-[9999] flex flex-col bg-gradient-to-br from-slate-900 via-[#0a2e38] to-[#1e1b4b] overflow-hidden animate-in fade-in zoom-in-95 duration-300">
      ...
      {/* HEADER (Glass) */}
      <div className="bg-white/10  border-b border-white/20 px-4 py-3 flex items-center justify-between shadow-lg z-30 shrink-0 relative">
        ...
        <div className="flex items-center gap-2">
           ...
           <button onClick={handleEndConsult} className="px-4 py-1.5 bg-rose-500/80 hover:bg-rose-500 text-white rounded-lg text-sm font-bold shadow-lg shadow-rose-500/20 transition-all  border border-rose-400/30">
             End Consult
           </button>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col lg:flex-row overflow-hidden relative z-10">
        ...
        <div className={`flex-1 flex flex-col relative transition-all duration-500
           ...
           bg-white  lg:border-l border-white/50 shadow-[-10px_0_30px_rgba(0,0,0,0.1)]
        `}>
          {/* PROGRESS BAR */}
          ...
          <div className="flex-1 overflow-y-auto p-4 md:p-8 custom-scrollbar">
            <div className="max-w-4xl mx-auto space-y-8 pb-32">
              ...
              {/* STEP 1: VITALS */}
              <div className="bg-white  rounded-[2rem] shadow-sm border border-white/60 p-6 md:p-8 space-y-6 animate-in slide-in-from-bottom-4 duration-500">
                  <div>
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    <div>
                      ...
                      <div className="relative">
                        <input type="text" className="w-full bg-white border border-white/60 rounded-xl px-4 py-3 text-slate-800 font-bold focus:border-teal-400 focus:bg-white/80 transition-all outline-none shadow-sm shadow-slate-100/50" placeholder="120/80" defaultValue="120/80" />
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input type="text" className="w-full bg-white border border-white/60 rounded-xl px-4 py-3 text-slate-800 font-bold focus:border-teal-400 focus:bg-white/80 transition-all outline-none shadow-sm shadow-slate-100/50" placeholder="72" defaultValue="72" />
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input type="text" className="w-full bg-white border border-white/60 rounded-xl px-4 py-3 text-slate-800 font-bold focus:border-teal-400 focus:bg-white/80 transition-all outline-none shadow-sm shadow-slate-100/50" placeholder="98.6" defaultValue="98.6" />
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input type="text" className="w-full bg-white border border-white/60 rounded-xl px-4 py-3 text-slate-800 font-bold focus:border-teal-400 focus:bg-white/80 transition-all outline-none shadow-sm shadow-slate-100/50" placeholder="70" defaultValue="70" />
              ...
              <div className="bg-white  rounded-[2rem] shadow-sm border border-white/60 p-6 md:p-8 space-y-6 animate-in slide-in-from-bottom-4 duration-500 relative">
                  ...
                  <div className="space-y-4">
                    <div>
                       ...
                       <textarea rows={4} className="w-full bg-white border border-white/60 rounded-2xl px-4 py-3 text-slate-800 focus:border-teal-400 focus:bg-white/80 transition-all outline-none resize-none shadow-sm shadow-slate-100/50" placeholder="E.g., Fever since 3 days, body ache..."></textarea>
                    </div>
                    
                    {/* AI CDSS Suggestions Block */}
                    <div className="bg-gradient-to-r from-indigo-500/10 to-blue-500/5  p-5 rounded-2xl border border-indigo-500/20 shadow-[0_4px_20px_rgba(99,102,241,0.05)] animate-in fade-in zoom-in-95 duration-500">
                      ...
                      <div className="flex flex-wrap gap-2">
                        <button className="bg-white/80  border border-indigo-200/50 text-indigo-800 px-4 py-2 rounded-xl text-sm font-bold shadow-[0_4px_12px_rgba(99,102,241,0.1)] hover:bg-indigo-600 hover:text-white transition-colors flex items-center gap-1.5">
                    ...
                    <div>
                       ...
                       <input type="text" className="w-full bg-white border border-white/60 rounded-xl px-4 py-3 text-slate-800 font-bold focus:border-teal-400 focus:bg-white/80 transition-all outline-none shadow-sm shadow-slate-100/50" placeholder="E.g., Viral Pyrexia" />
                    </div>
                  </div>
                </div>
              {/* STEP 3: RX GRID */}
              <div className="bg-white  rounded-[2rem] shadow-sm border border-white/60 p-6 md:p-8 space-y-6 animate-in slide-in-from-bottom-4 duration-500">
                  ...
                  <div className="p-4 bg-white  rounded-2xl border border-white/60 flex flex-col md:flex-row gap-3 shadow-sm shadow-slate-100/50">
                  ...
                  <div className="space-y-2 mt-4">
                     <div className="p-4 border border-white/60 rounded-xl flex items-center justify-between hover:border-teal-200 transition-colors bg-white  shadow-sm">
                        <div>
              ...
              <div className="bg-white  rounded-[2rem] shadow-sm border border-white/60 p-6 md:p-8 space-y-6 animate-in slide-in-from-bottom-4 duration-500">
                  ...
                  {/* AI Lab Suggestions */}
                  <div className="bg-gradient-to-r from-teal-500/10 to-emerald-500/5  p-5 rounded-2xl border border-teal-500/20 shadow-[0_4px_20px_rgba(20,184,166,0.05)] mb-4 animate-in fade-in duration-500">
                    <div className="flex items-center gap-2 mb-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <button className="bg-white/80  border border-teal-200/50 text-teal-800 px-4 py-2 rounded-xl text-sm font-bold shadow-[0_4px_12px_rgba(20,184,166,0.1)] hover:bg-teal-600 hover:text-white transition-colors flex items-center gap-1.5">
                  ...
                  <div className="space-y-4">
                    <div>
                       ...
                       <input type="text" className="w-full bg-white border border-white/60 rounded-xl px-4 py-3 text-slate-800 focus:border-teal-400 focus:bg-white/80 transition-all outline-none shadow-sm shadow-slate-100/50" placeholder="E.g., Complete Blood Count (CBC)" />
                    </div>
                    <div>
                       <label className="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-1.5">Diet & Lifestyle Advice</label>
                       <textarea rows={3} className="w-full bg-white border border-white/60 rounded-2xl px-4 py-3 text-slate-800 focus:border-teal-400 focus:bg-white/80 transition-all outline-none resize-none shadow-sm shadow-slate-100/50" placeholder="Drink plenty of warm water..."></textarea>
                    </div>
                  </div>
                </div>
            </div>
...
function InlineVideoGrid({ patientName, patientHasVideo, isMini = false }: { patientName: string, patientHasVideo: boolean, isMini?: boolean }) {
  ...
  return (
    <div className="absolute inset-0 w-full h-full bg-slate-900 flex flex-col z-10 overflow-hidden pointer-events-auto">
      ...
      {!isMini && (
        <div className="absolute top-4 left-4 bg-black/60  text-white text-xs px-3 py-1.5 rounded-full font-bold border border-white/10 flex items-center gap-2 shadow-lg z-30 pointer-events-auto">
      ...
      {/* Controls */}
      {!isMini && (
        <div className="absolute bottom-4 lg:bottom-8 left-1/2 -translate-x-1/2 bg-black/50  border border-white/10 rounded-full px-4 lg:px-6 py-2.5 flex items-center justify-center gap-3 lg:gap-4 shadow-2xl z-30 pointer-events-auto">
